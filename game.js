class StartScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(this.cameras.main.centerX, 300, "Find all matches before time runs out!", {
      fontSize: "22px",
      fill: "#000"
    }).setOrigin(0.5);

    this.add.text(this.cameras.main.centerX, 380, "Press SPACE to Start", {
      fontSize: "28px",
      fill: "#1d4ed8"
    }).setOrigin(0.5);
...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(this.cameras.main.centerX, 20, "Memory Match Game", {
      fontSize: "34px",
      fill: "#000"
    }).setOrigin(0.5);
    ...
    this.messageText = this.add.text(this.cameras.main.centerX, 545, "Click two cards to find a match!", {
      fontSize: "22px",
      fill: "#000"
    }).setOrigin(0.5);
...
class WinScene extends Phaser.Scene {
  ...
  create(data) {
    ...
    this.add.text(this.cameras.main.centerX, 190, "You Win!", {
      fontSize: "48px",
      fill: "#000"
    }).setOrigin(0.5);

    this.add.text(this.cameras.main.centerX, 280, "Score: " + data.score, {
      fontSize: "30px",
      fill: "#000"
    }).setOrigin(0.5);

    this.add.text(this.cameras.main.centerX, 330, "Time Left: " + data.timeLeft, {
      fontSize: "30px",
      fill: "#000"
    }).setOrigin(0.5);

    this.add.text(this.cameras.main.centerX, 420, "Press R to Restart", {
      fontSize: "28px",
      fill: "#166534"
    }).setOrigin(0.5);
...
class LoseScene extends Phaser.Scene {
  ...
  create(data) {
    ...
    this.add.text(this.cameras.main.centerX, 290, "Score: " + data.score, {
      fontSize: "30px",
      fill: "#000"
    }).setOrigin(0.5);

    this.add.text(this.cameras.main.centerX, 390, "Press R to Try Again", {
      fontSize: "28px",
      fill: "#991b1b"
    }).setOrigin(0.5);
